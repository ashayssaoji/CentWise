...
const initialize = (app) => {
  ...
  mongoose.connect('mongodb+srv://ashayssaoji:01q69ex6Lx7QtvVP@centwise.p4nzxgn.mongodb.net/?retryWrites=true&w=majority&appName=CentWise');
  //MongoDB connection
  ...
  app.use(session({
    ...
    uri: 'mongodb+srv://ashayssaoji:01q69ex6Lx7QtvVP@centwise.p4nzxgn.mongodb.net/?retryWrites=true&w=majority&appName=CentWise',
    collection: 'sessions'
  })
})); 
